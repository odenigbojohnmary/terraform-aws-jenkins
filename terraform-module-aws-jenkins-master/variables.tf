...
variable "solution_stack_name" {
  type        = string
  default     = "64bit Amazon Linux 2018.03 v2.14.3 running Docker 18.09.9-ce"
...
variable "github_organization" {
  type        = string
  default     = "bantrain"
  description = "GitHub organization, e.g. 'bantrain'. By default, this module will deploy 'https://github.com/bantrain/jenkins' repository"
}

variable "github_repo_name" {
  type        = string
  default     = "jenkins"
  description = "GitHub repository name, e.g. 'jenkins'. By default, this module will deploy 'https://github.com/bantrain/jenkins' repository"
}

variable "github_branch" {
  type        = string
  default     = "master"
  description = "GitHub repository branch, e.g. 'master'. By default, this module will deploy 'https://github.com/bantrain/jenkins' master branch"
}
